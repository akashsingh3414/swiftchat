...
import { connectToSpace, createSpace, deleteSpace, getMembersForSpace, getMessagesForSpace, getSpacesForSidebar, leaveSpace, modifyInvite, removeFromSpace, spaceWatchHistory } from '../controllers/space.controllers.js';
...
spaceRouter.delete('/remove-user',protectRoute, removeFromSpace)
